        ...
        <div class="offset-4">
            <div class="card" style="width: 22rem; margin-top:-15px;background:none !important; border:none;">
                <div class="card-body text-center">
                    <img class="card-img-top mb-3" src="images/icon.png" style="width:90px !important; margin-top:150px !important;" height="80"
                        alt="Card image cap">
                ...
                <ul class="list-group list-group-flush" style="margin-top:-20px;">
                    <li class="list-group-item bg-info" style="background:none !important;">
                        <input type="email" placeholder="you@example.com" class="form-control mb-2" style="width:350px !important;" required>
                    </li>
                    <!--
                    ...
                    <tr>
                        <td>
                            <div style="margin-left:20px;">
                                <input type="password" placeholder="*****" class="form-control" style="width:350px !important;" required id="pass">
                            </div>
                        </td>
                        <td>
                ...
                <div class="row no-gutters">
                    <!--
                            ...
                            -->
                    <div class="col-7">
                        <a href="register.html" class="badge ml-3 text-warning" style="text-decoration:none;">
                            <span style="font-size:13px;">No account?</span>
                        </a>
                    </div>
                    <div class="col-5">
                        <a href="#" class="badge ml-5 text-warning" style="text-decoration:none;">
                            <span style="font-size:13px;">Forgot password?</span>
                        </a>
                    </div>
                </div>
                <div class="card-body text-center">
                    <button class="btn btn-warning text-white">Login

            ...
            <div id="bg">
                <div class="offset-4">
                    <div class="card" style="width: 22rem; margin-top:-15px;background:none !important; border:none;">
                        ...
                        <table>
                            <tr>
                                <td><div style="margin-left:20px;"><input type="password" placeholder="New password..." class="form-control" style="width:350px !important;" required id="passLog" name="passLog"></div></td>
                                <td>
                ...
                $.ajax({
                    ...
                    success: function (data){
                        if(data.indexOf('sent') > -1){
							...
							$("#alertLog").html('Password change successfully');
							$("#alertLog").slideDown(500).delay(1000).slideUp(500);
                            $('#emailLog').val("");
                            $('#passLog').val("");
                        }else {

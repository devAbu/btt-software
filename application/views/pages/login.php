                ...
                <div class="offset-4">
                    <div class="card" style="width: 22rem; margin-top:-15px;background:none !important; border:none;">
                        ...
                        <div class="row no-gutters">
                            ...
                            -->
                            <div class="col-7">
                                <a href="register" class="badge ml-3 text-warning" style="text-decoration:none;"><span style="font-size:13px;">No account?</span></a>
                            </div>
                            <div class="col-5">
                                <a href="forgotPass" class="badge ml-5 text-warning" style="text-decoration:none;"><span style="font-size:13px;">Forgot password?</span></a>
                            </div>
                        </div>
                        <div class="card-body text-center">

    ...
    <nav class="navbar bg-warning navbar-light  navbar-expand-md fixed-top" style="opacity:0.7; font-size:18px;">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav" id="navScrollspy">
                ...
                <li class="nav-item">
                    <a href="tourPlans.html" class="nav-link">
        ...
        <div class="offset-lg-4 ">
            <div class="card" style="width: 22rem; margin-top:-30px;background:none !important; border:none;">
                <div class="card-body text-center">
                    <img class="card-img-top" src="images/icon.png" style="width:90px !important; margin-top:150px !important; margin-left:100px !important;"
                ...
                <ul class="list-group list-group-flush" style="margin-top:-20px;">
                    <li class="list-group-item bg-info" style="background:none !important;">
                        <input type="text" placeholder="First name..." class="form-control mb-2" required="">
                    </li>
                    <li class="list-group-item bg-info" style="border:none; margin-top:-20px; background:none !important;">
                        <input type="text" placeholder="Last name..." class="form-control mb-2" style="width:400px;" required="">
                    </li>
                    <li class="list-group-item bg-info" style="border:none; margin-top:-20px; background:none !important;">
                        <input type="email" placeholder="you@example.com" class="form-control " style="width:400px;" required="">
                    </li>
                    <!--<li class="list-group-item bg-info" style="border:none; margin-top:-20px; background:none !important;">
                    ...
                    <tr>
                        <td>
                            <div style="margin-left:18px;">
                                <input type="password" placeholder="*****" class="form-control" style="width:400px !important;" required id="pass">
                            </div>
                        </td>
                        <td>
                            <button type="button" class="btn btn-outline-warning" style="margin-left:-44px !important;">
                ...
                <div style="margin-top:-10px;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item bg-info" style="background:none !important;">
                            <a href="login.html" class="badge text-warning" style="text-decoration:none;">
                ...
                <div class="card-body text-center" style="margin-left:100px !important;">
                    <button class="btn btn-warning text-white">Sign up for free
